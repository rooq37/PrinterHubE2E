...
public class OtherUsersPage extends BasePage {
    ...
    private static final By selectorResultTable = By.xpath("//table[@class='sortable table row-container']//tbody");
    ...
    public void clickSeeMoreButtonAtRow(String rowContent){
        By selectorTableRow = By.xpath("//table[@class='sortable table row-container']/tbody/tr");
        ...
        index += 1;
        By selectorSeeMore = By.xpath("//table[@class='sortable table row-container']/tbody/tr[" + index + "]//a[text()='See more']");
